...
public:
  ...
  Return runFunctionHelper(void* foreignAddr, Args... args);
...
template <typename Return, typename... Args>
Return ForeignThread::runFunctionHelper(void* foreignAddr, Args... args){
  ...
  runFunction(foreignAddr, retArg, argv);
